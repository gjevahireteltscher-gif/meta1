...
so far ("Waterloo announced...", "Moscow signed...", "Anna examines...")
...
class GfParseDiagnosticMatrix(unittest.TestCase):
    ...
    def test_baseline_single_word_subject_and_object_parses(self) -> None:
        self.assert_parses("Waterloo announced a programme")
    ...
    def test_two_word_proper_noun_subject(self) -> None:
        ...
        self.assert_parses("Henry County announced a programme")
    ...
    def test_two_word_proper_noun_object(self) -> None:
        ...
        self.assert_parses("Waterloo announced Henry County")
    ...
    def test_three_word_proper_noun_subject(self) -> None:
        ...
        interact with)."""
        self.assert_parses("Shipley School announced a programme")
